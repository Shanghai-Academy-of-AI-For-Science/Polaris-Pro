...
# centers come from a JSON file in ``mkb/data/assets/ea_bin_edges_<N>.json``.
...
def _ea_default_edges_path(n_bins: int) -> str:
    # Packaged next to this file: mkb/data/assets/ea_bin_edges_<N>.json
...
def ea_load_bin_table(n_bins: int) -> Dict[str, Any]:
    ...
    Lookup order:
      ...
      2. ``mkb/data/assets/ea_bin_edges_<N>.json`` (packaged)
    """
